  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center h-screen">
        <div
          className="relative w-[250px] h-[250px] rounded-full overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.198),-5px_0_8px_rgba(195,244,255,0.99)_inset,15px_2px_25px_rgba(0,0,0,0.99)_inset,-24px_-2px_34px_rgba(195,244,255,0.594)_inset,250px_0_44px_rgba(0,0,0,0.396)_inset,150px_0_38px_rgba(0,0,0,0.66)_inset]"
          style={{
