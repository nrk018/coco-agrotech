            ...
            return (
                <g key={index}>
                    ...
                    >
                        <textPath
                            href="#curve"
                            className="fill-black hover:fill-[#2ea043]"
    ...
    return (
        <>
            ...
            >
                ...
                <motion.div
                    className="absolute inset-[12px] rounded-full bg-[#e6e6e6] z-20"
                    style={{
                ...
                <motion.div
                    ...
                    style={{ zIndex: 30 }}
                >
                    <svg viewBox="0 0 400 400" className="w-full h-full" style={{ zIndex: 30 }}>
                        <defs>
